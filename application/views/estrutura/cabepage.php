...
<head>
 ...
 <link href="<?php echo base_url(); ?>public/template/vendor/datatables/dataTables.bootstrap4.min.css" rel="stylesheet">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?php echo base_url('index'); ?>">
        ...
        <div class="sidebar-brand-text mx-3">Projeto consultorio <!--<sup>2</sup>--></div>
      </a>
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Cadastro de clinicas</h6>
            <a class="collapse-item" href="<?php echo base_url('clinicas'); ?>">Clinicas</a>
            <a class="collapse-item" href="<?php echo base_url('users'); ?>">Usuarios</a>
          </div>
        </div>
      </li>
